...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_LGUI, LT(SYMBOLS, KC_ENT), HYPR_T(KC_TAB),      LT(EXTEND, KC_BSPC), LT(NUMBERS, KC_SPC), KC_BSPC, KC_NO, KC_NO
    ),
    ...
    [SYMBOLS] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX,                                 XXXXXXX, MO(FUNCTION), XXXXXXX, XXXXXXX, XXXXXXX
    ),

    [NUMBERS] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_PAST, KC_P7, KC_P8, KC_P9, KC_PMNS, _______,
        XXXXXXX, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LCTL), OSM(MOD_LSFT), OSM(MOD_HYPR),                        KC_PEQL, KC_P4, KC_P5, KC_P6, KC_PPLS, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX, KC_P0, KC_P1, KC_P2, KC_P3, KC_PSLS, XXXXXXX,
        XXXXXXX, XXXXXXX, _______, MO(FUNCTION), XXXXXXX,                                 _______, _______, _______, XXXXXXX, XXXXXXX
    ),
